...
export const resetPassword = async (req, res) => {
    try {
        ...
        const results = await Promise.all(passwordHistory.map(entry => bcrypt.compare(password, entry.oldHash)));
...
// const checkRequestErrors = (req: express.Request, res: express.Response): {
//     isError: boolean,
...
//             errors: errors.array()
//         })
//         return {isError: true, errors: errors.array()}
//     }
//     return {isError: false, errors: errors.array()}
//
// }
